...
This applies to any agent with Bash access. Use `git
stash` when the changes are not ready to commit, or a WIP
commit when they are ready to land but the current task
is not yet complete.
