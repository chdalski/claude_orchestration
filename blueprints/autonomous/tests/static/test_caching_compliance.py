...
from conftest import AGENTS_DIR, CLAUDE_MD, CLAUDE_MD_TEMPLATE, PLAN_FORMAT_TEMPLATE, PLAN_REVIEW_CHECKLIST_TEMPLATE, RULES_DIR
...
def _static_files():
    ...
    yield PLAN_REVIEW_CHECKLIST_TEMPLATE
